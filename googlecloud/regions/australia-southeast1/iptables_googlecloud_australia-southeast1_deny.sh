...
iptables -A INPUT -s 34.183.59.0/24 -j DROP
iptables -A INPUT -s 34.183.119.0/24 -j DROP
iptables -A INPUT -s 34.184.2.0/24 -j DROP
iptables -A INPUT -s 34.184.58.0/24 -j DROP
iptables -A INPUT -s 34.184.118.0/24 -j DROP
...
ip6tables -A INPUT -s 2600:1902:b0::/44 -j DROP
