...
iptables -A INPUT -s 8.230.64.0/19 -j DROP
...
iptables -A INPUT -s 34.183.69.0/24 -j DROP
iptables -A INPUT -s 34.183.122.0/24 -j DROP
iptables -A INPUT -s 34.184.68.0/24 -j DROP
iptables -A INPUT -s 34.184.119.0/24 -j DROP
iptables -A INPUT -s 35.252.32.0/19 -j DROP
ip6tables -A INPUT -s 2600:1900:5400::/44 -j DROP
ip6tables -A INPUT -s 2600:1902:1b0::/44 -j DROP
