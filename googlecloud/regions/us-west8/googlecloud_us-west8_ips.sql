...
INSERT INTO `googlecloud_us-west8_ips` (`ip_address`, `ip_type`) VALUES ('34.2.32.0/20', 'IPv4');
...
INSERT INTO `googlecloud_us-west8_ips` (`ip_address`, `ip_type`) VALUES ('2600:1902:2d0::/44', 'IPv6');
