...
iptables -A INPUT -s 106.13.252.0/22 -j DROP
...
iptables -A INPUT -s 180.76.16.0/20 -j DROP
iptables -A INPUT -s 180.76.32.0/19 -j DROP
iptables -A INPUT -s 180.76.64.0/18 -j DROP
