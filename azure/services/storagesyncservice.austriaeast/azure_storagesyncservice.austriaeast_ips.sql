-- SQL script to create table `azure_storagesyncservice.austriaeast_ips` and insert IP addresses

CREATE TABLE IF NOT EXISTS `azure_storagesyncservice.austriaeast_ips` (
