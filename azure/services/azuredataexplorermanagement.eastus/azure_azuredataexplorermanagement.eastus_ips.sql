...
INSERT INTO `azure_azuredataexplorermanagement.eastus_ips` (`ip_address`, `ip_type`) VALUES ('48.195.238.128/28', 'IPv4');
INSERT INTO `azure_azuredataexplorermanagement.eastus_ips` (`ip_address`, `ip_type`) VALUES ('48.202.151.64/28', 'IPv4');
