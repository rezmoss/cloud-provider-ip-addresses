...
INSERT INTO `azure_azureportal.southeastasia_ips` (`ip_address`, `ip_type`) VALUES ('13.67.35.35/32', 'IPv4');
INSERT INTO `azure_azureportal.southeastasia_ips` (`ip_address`, `ip_type`) VALUES ('13.67.35.77/32', 'IPv4');
...
INSERT INTO `azure_azureportal.southeastasia_ips` (`ip_address`, `ip_type`) VALUES ('52.163.207.80/32', 'IPv4');
INSERT INTO `azure_azureportal.southeastasia_ips` (`ip_address`, `ip_type`) VALUES ('57.155.102.64/27', 'IPv4');
INSERT INTO `azure_azureportal.southeastasia_ips` (`ip_address`, `ip_type`) VALUES ('104.215.146.128/32', 'IPv4');
