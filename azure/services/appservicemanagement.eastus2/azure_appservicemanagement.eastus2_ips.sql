...
INSERT INTO `azure_appservicemanagement.eastus2_ips` (`ip_address`, `ip_type`) VALUES ('57.167.187.64/26', 'IPv4');
...
INSERT INTO `azure_appservicemanagement.eastus2_ips` (`ip_address`, `ip_type`) VALUES ('2603:1030:40c:2a::4c0/122', 'IPv6');
