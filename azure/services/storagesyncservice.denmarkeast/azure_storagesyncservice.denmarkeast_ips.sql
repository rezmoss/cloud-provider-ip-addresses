-- SQL script to create table `azure_storagesyncservice.denmarkeast_ips` and insert IP addresses

CREATE TABLE IF NOT EXISTS `azure_storagesyncservice.denmarkeast_ips` (
...
INSERT INTO `azure_storagesyncservice.denmarkeast_ips` (`ip_address`, `ip_type`) VALUES ('9.205.210.184/29', 'IPv4');
