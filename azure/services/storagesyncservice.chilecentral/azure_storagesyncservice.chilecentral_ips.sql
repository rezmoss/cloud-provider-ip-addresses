-- SQL script to create table `azure_storagesyncservice.chilecentral_ips` and insert IP addresses

CREATE TABLE IF NOT EXISTS `azure_storagesyncservice.chilecentral_ips` (
