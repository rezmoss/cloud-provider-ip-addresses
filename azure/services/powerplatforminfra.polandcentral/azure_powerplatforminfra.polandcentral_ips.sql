...
INSERT INTO `azure_powerplatforminfra.polandcentral_ips` (`ip_address`, `ip_type`) VALUES ('134.112.64.40/29', 'IPv4');
INSERT INTO `azure_powerplatforminfra.polandcentral_ips` (`ip_address`, `ip_type`) VALUES ('134.112.64.64/26', 'IPv4');
