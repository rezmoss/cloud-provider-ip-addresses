...
iptables -A INPUT -s 20.20.65.96/30 -j DROP
iptables -A INPUT -s 20.20.65.100/31 -j DROP
...
ip6tables -A INPUT -s 2603:1061:1010:a8::/63 -j DROP
ip6tables -A INPUT -s 2603:1061:1010:aa::/64 -j DROP
