...
iptables -A INPUT -s 20.20.65.96/29 -j DROP
iptables -A INPUT -s 20.20.65.104/31 -j DROP
...
ip6tables -A INPUT -s 2603:1061:1010:a8::/62 -j DROP
ip6tables -A INPUT -s 2603:1061:1010:ac::/64 -j DROP
