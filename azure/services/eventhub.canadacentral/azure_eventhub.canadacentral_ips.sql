...
INSERT INTO `azure_eventhub.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('40.85.226.62/32', 'IPv4');
INSERT INTO `azure_eventhub.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('40.85.229.32/32', 'IPv4');
INSERT INTO `azure_eventhub.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('52.139.4.118/32', 'IPv4');
INSERT INTO `azure_eventhub.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('52.233.30.41/32', 'IPv4');
INSERT INTO `azure_eventhub.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('52.237.33.36/32', 'IPv4');
