-- SQL script to create table `azure_gatewaymanager.jioindiawest_ips` and insert IP addresses

CREATE TABLE IF NOT EXISTS `azure_gatewaymanager.jioindiawest_ips` (
