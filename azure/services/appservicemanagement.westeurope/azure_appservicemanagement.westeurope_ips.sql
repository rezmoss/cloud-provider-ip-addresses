...
INSERT INTO `azure_appservicemanagement.westeurope_ips` (`ip_address`, `ip_type`) VALUES ('172.199.232.10/31', 'IPv4');
INSERT INTO `azure_appservicemanagement.westeurope_ips` (`ip_address`, `ip_type`) VALUES ('172.199.232.96/29', 'IPv4');
