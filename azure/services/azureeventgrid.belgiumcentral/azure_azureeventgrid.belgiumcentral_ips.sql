-- SQL script to create table `azure_azureeventgrid.belgiumcentral_ips` and insert IP addresses

CREATE TABLE IF NOT EXISTS `azure_azureeventgrid.belgiumcentral_ips` (
