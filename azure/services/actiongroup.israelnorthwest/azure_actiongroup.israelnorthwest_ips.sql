-- SQL script to create table `azure_actiongroup.israelnorthwest_ips` and insert IP addresses

CREATE TABLE IF NOT EXISTS `azure_actiongroup.israelnorthwest_ips` (
