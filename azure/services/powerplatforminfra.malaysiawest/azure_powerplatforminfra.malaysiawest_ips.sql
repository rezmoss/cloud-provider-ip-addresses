-- SQL script to create table `azure_powerplatforminfra.malaysiawest_ips` and insert IP addresses

CREATE TABLE IF NOT EXISTS `azure_powerplatforminfra.malaysiawest_ips` (
