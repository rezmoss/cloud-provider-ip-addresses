...
INSERT INTO `azure_azureeventgrid.koreacentral_ips` (`ip_address`, `ip_type`) VALUES ('4.230.188.0/22', 'IPv4');
INSERT INTO `azure_azureeventgrid.koreacentral_ips` (`ip_address`, `ip_type`) VALUES ('4.230.200.0/22', 'IPv4');
