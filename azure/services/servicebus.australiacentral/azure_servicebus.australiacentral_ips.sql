...
INSERT INTO `azure_servicebus.australiacentral_ips` (`ip_address`, `ip_type`) VALUES ('20.36.46.187/32', 'IPv4');
...
INSERT INTO `azure_servicebus.australiacentral_ips` (`ip_address`, `ip_type`) VALUES ('20.213.247.76/32', 'IPv4');
