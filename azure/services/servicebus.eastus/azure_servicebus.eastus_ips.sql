...
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('13.82.27.247/32', 'IPv4');
...
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('40.114.86.33/32', 'IPv4');
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('40.114.111.22/32', 'IPv4');
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('40.121.88.231/32', 'IPv4');
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('52.168.29.86/32', 'IPv4');
...
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('52.168.133.227/32', 'IPv4');
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('52.226.22.118/32', 'IPv4');
...
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('168.62.48.238/32', 'IPv4');
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('168.62.54.52/32', 'IPv4');
INSERT INTO `azure_servicebus.eastus_ips` (`ip_address`, `ip_type`) VALUES ('172.173.179.62/32', 'IPv4');
