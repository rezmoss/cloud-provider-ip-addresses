...
INSERT INTO `azure_azureeventgrid.westeurope_ips` (`ip_address`, `ip_type`) VALUES ('13.80.198.220/30', 'IPv4');
INSERT INTO `azure_azureeventgrid.westeurope_ips` (`ip_address`, `ip_type`) VALUES ('13.80.207.0/25', 'IPv4');
INSERT INTO `azure_azureeventgrid.westeurope_ips` (`ip_address`, `ip_type`) VALUES ('13.80.213.0/25', 'IPv4');
