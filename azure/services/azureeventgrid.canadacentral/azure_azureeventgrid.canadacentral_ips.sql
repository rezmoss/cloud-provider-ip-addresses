...
INSERT INTO `azure_azureeventgrid.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('4.173.28.0/22', 'IPv4');
INSERT INTO `azure_azureeventgrid.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('4.173.88.0/22', 'IPv4');
