...
INSERT INTO `azure_azureattestation.australiaeast_ips` (`ip_address`, `ip_type`) VALUES ('4.198.249.36/30', 'IPv4');
INSERT INTO `azure_azureattestation.australiaeast_ips` (`ip_address`, `ip_type`) VALUES ('4.198.249.96/29', 'IPv4');
