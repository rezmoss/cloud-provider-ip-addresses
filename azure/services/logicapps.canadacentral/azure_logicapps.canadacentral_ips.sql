...
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('13.71.184.150/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('13.71.186.1/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('13.88.249.209/32', 'IPv4');
...
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('40.85.241.105/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('40.85.250.135/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('40.85.250.212/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('40.85.252.47/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('52.228.39.244/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('52.233.29.79/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('52.233.29.92/32', 'IPv4');
INSERT INTO `azure_logicapps.canadacentral_ips` (`ip_address`, `ip_type`) VALUES ('52.233.30.218/32', 'IPv4');
