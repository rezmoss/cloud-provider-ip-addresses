...
INSERT INTO `azure_powerplatformplex.westus_ips` (`ip_address`, `ip_type`) VALUES ('48.195.24.64/26', 'IPv4');
INSERT INTO `azure_powerplatformplex.westus_ips` (`ip_address`, `ip_type`) VALUES ('48.195.24.128/25', 'IPv4');
INSERT INTO `azure_powerplatformplex.westus_ips` (`ip_address`, `ip_type`) VALUES ('48.195.25.0/24', 'IPv4');
INSERT INTO `azure_powerplatformplex.westus_ips` (`ip_address`, `ip_type`) VALUES ('48.195.26.0/23', 'IPv4');
INSERT INTO `azure_powerplatformplex.westus_ips` (`ip_address`, `ip_type`) VALUES ('48.195.28.0/23', 'IPv4');
INSERT INTO `azure_powerplatformplex.westus_ips` (`ip_address`, `ip_type`) VALUES ('48.195.30.0/26', 'IPv4');
