...
iptables -A INPUT -s 4.166.35.241/32 -j DROP
iptables -A INPUT -s 4.223.198.160/29 -j DROP
iptables -A INPUT -s 4.223.198.168/31 -j DROP
...
iptables -A INPUT -s 74.158.64.192/26 -j DROP
