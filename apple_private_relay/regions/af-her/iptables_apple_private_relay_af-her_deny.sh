...
iptables -A INPUT -s 104.28.37.2/31 -j DROP
iptables -A INPUT -s 104.28.51.2/31 -j DROP
iptables -A INPUT -s 104.28.80.2/31 -j DROP
iptables -A INPUT -s 104.28.106.2/31 -j DROP
