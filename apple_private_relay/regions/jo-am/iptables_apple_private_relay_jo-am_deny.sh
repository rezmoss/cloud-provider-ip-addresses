...
iptables -A INPUT -s 104.28.60.100/30 -j DROP
iptables -A INPUT -s 104.28.60.104/32 -j DROP
iptables -A INPUT -s 104.28.80.140/30 -j DROP
iptables -A INPUT -s 104.28.80.144/32 -j DROP
iptables -A INPUT -s 104.28.106.114/31 -j DROP
iptables -A INPUT -s 104.28.106.116/31 -j DROP
iptables -A INPUT -s 104.28.106.118/32 -j DROP
iptables -A INPUT -s 104.28.130.91/32 -j DROP
iptables -A INPUT -s 104.28.130.92/30 -j DROP
iptables -A INPUT -s 104.28.131.87/32 -j DROP
iptables -A INPUT -s 104.28.131.88/30 -j DROP
