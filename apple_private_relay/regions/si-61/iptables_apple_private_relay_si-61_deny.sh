...
iptables -A INPUT -s 104.28.60.192/31 -j DROP
iptables -A INPUT -s 104.28.98.80/31 -j DROP
iptables -A INPUT -s 104.28.114.59/32 -j DROP
iptables -A INPUT -s 104.28.114.60/32 -j DROP
iptables -A INPUT -s 104.28.130.138/31 -j DROP
iptables -A INPUT -s 104.28.135.74/31 -j DROP
iptables -A INPUT -s 104.28.137.20/32 -j DROP
