...
iptables -A INPUT -s 172.225.174.96/31 -j DROP
...
ip6tables -A INPUT -s 2a02:26f7:d6c8:680a::/64 -j DROP
ip6tables -A INPUT -s 2a02:26f7:d6c8:68e0::/60 -j DROP
ip6tables -A INPUT -s 2a02:26f7:d6c8:68f0::/64 -j DROP
