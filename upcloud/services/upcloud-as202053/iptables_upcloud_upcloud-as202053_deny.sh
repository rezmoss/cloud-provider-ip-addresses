...
iptables -A INPUT -s 95.111.192.0/20 -j DROP
iptables -A INPUT -s 95.111.208.0/22 -j DROP
...
iptables -A INPUT -s 193.104.38.0/24 -j DROP
...
ip6tables -A INPUT -s 2001:67c:70::/48 -j DROP
