...
iptables -A INPUT -s 15.156.32.59/32 -j DROP
iptables -A INPUT -s 15.222.164.249/32 -j DROP
iptables -A INPUT -s 15.156.255.184/32 -j DROP
iptables -A INPUT -s 3.98.151.27/32 -j DROP
iptables -A INPUT -s 3.96.73.34/32 -j DROP
iptables -A INPUT -s 35.182.178.44/32 -j DROP
